!function(e, t) {
    ...
    return function(e) {
        ...
        "object" === ("undefined" == typeof document ? "undefined" : S(document)) && ((o = document.createElement("style")).className = i,
        ...
        function L(e, t, n, o) {
            ...
            ;
            var c = function() {
                i[t].style.width = a * s + "px",
                i[t].style.height = a + "px"
            }
        }
        function C(e, t) {
            var n = this
        ...
        function F(e, t) {
            var n, o = this, r = e.elements.sources, i = e.props, s = (0,
            e.resolve)(C, [t]);
        ...
        function N(e, t) {
            ...
            i[t].src = "https://www.youtube.com/embed/".concat(a[t].match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2], "?enablejsapi=1"),
        ...
        function O(e, t, n, o) {
            ...
            return s.setAttributeNS(null, "class", "".concat(r, "svg-path")),
        ...
        function R(e, t) {
            ...
            return n.className = "".concat(r, "toolbar-button ").concat(c),
            n.title = t,
            e.appendChild(n),
            n
        }
        ...
        function V(e) {
            ...
            this.runActions = function() {
                ...
                i.removeListeners(),
                u.exitFullscreenOnClose && a.isFullscreenOpen && r.exitFullscreen(),
                setTimeout((function() {
        ...
        function Y(e) {
            var t, n, o, r = e.collections.sourceMainWrappersTransformers, i = e.componentsServices, s = e.core, a = s.classFacade, c = s.slideIndexChanger, l = s.sourceDisplayFacade, d = s.stageManager, p = e.elements.sourceAnimationWrappers, f = e.stageIndexes, v = (t = function() {
        ...
        function G(e) {
            ...
            this.runPositiveSwipedXActions = function() {
                void 0 === r.previous || (i("positive"),
                n.changeTo(r.previous)),
                i("zero")
            }
            ,
            this.runNegativeSwipedXActions = function() {
                void 0 === r.next || (i("negative"),
                n.changeTo(r.next)),
                i("zero")
            }
            ;
            var i = function(e) {
                o[r.current].classList.add(u),
                t[r.current][e]()
            }
        }
        function $(e, t) {
        ...
        function te(e) {
            ...
            o.container.className = "".concat(r, "container ").concat(a, " ").concat(g),
            function(e) {
                var t = e.elements;
                t.slideSwipingHoverer = document.createElement("div"),
                t.slideSwipingHoverer.className = "".concat(r, "slide-swiping-hoverer ").concat(a, " ").concat(d)
            }(e),
            j(e),
            function(e) {
        ...
        function ce() {
            for (var e = document.getElementsByTagName("a"), t = function(t) {
                ...
                var r = null;
                r = "#" === o.charAt(0) ? document.getElementById(o.substring(1)) : o,
